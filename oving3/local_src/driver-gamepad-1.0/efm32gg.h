...
#define GPIO_PC_CTRL     ((volatile uint32_t*)(0x00))
#define GPIO_PC_MODEL    ((volatile uint32_t*)(0x04))
#define GPIO_PC_MODEH    ((volatile uint32_t*)(GPIO_PC_BASE + 0x08))
#define GPIO_PC_DOUT     ((volatile uint32_t*)(0x0c))
...
#define GPIO_PC_DIN      ((volatile uint32_t*)(0x1c))
#define GPIO_PC_PINLOCKN ((volatile uint32_t*)(GPIO_PC_BASE + 0x20))

#define GPIO_EXTIPSELL ((volatile uint32_t*)(0x100))
#define GPIO_EXTIPSELH ((volatile uint32_t*)(0x104))
#define GPIO_EXTIRISE  ((volatile uint32_t*)(0x108))
#define GPIO_EXTIFALL  ((volatile uint32_t*)(0x10c))
#define GPIO_IEN       ((volatile uint32_t*)(0x110))
#define GPIO_IFC       ((volatile uint32_t*)(0x11c))
